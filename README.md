...
- Used a game of thrones casts API to fetch data and built a pagination component.
- Create the paginate component from scratch.
...
b: render the pagination component and sent the data to it with props.